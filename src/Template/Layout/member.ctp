...
<body class="member-dashboard hold-transition <?= get_option(
    ...
    <div class="wrapper">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown messages-menu">
                            ...
                            <a href="<?= $this->Url->build([
                                ...
                                <span class="hidden-xs"><?= __('Available Balance') ?>:
                                </span><?= display_price_currency($logged_user->publisher_earnings + $logged_user->referral_earnings); ?>
                            </a>
                        </li>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <button type="button" class="btn btn-block btn-social btn-github btn-lg shorten-button"
                    data-toggle="modal" data-target="#myModal"><i class="fa fa-paper-plane"></i>
                    <span><?= __("New Shorten Link") ?></span>
                </button>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        <a href="#"><i class="fa fa-unlock-alt"></i> <span><?= __('Sub2Unlock') ?></span> <i
                                class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                            <li><a href="<?php echo $this->Url->build([
                                'controller' => 'Links',
                            ...
                            <li><a href="<?php echo $this->Url->build([
                                ...
                                'action' => 'index',
                            ]); ?>"><?= __('My Platforms') ?></a></li>
                            <li><a href="<?php echo $this->Url->build([
                                'controller' => 'PlatformActions',
                                'action' => 'index',
                            ]); ?>"><?= __('My Actions') ?></a></li>
                        </ul>
                    </li>
                    ...
                    <?php if ((bool) get_option('enable_referrals', 1)): ?>
                        <li><a href="<?php echo $this->Url->build([
                            'controller' => 'Users',
                            'action' => 'referrals',
                        ]); ?>"><i class="fa fa-exchange"></i> <span><?= __('Referrals') ?></span></a></li>
                    <?php endif; ?>
